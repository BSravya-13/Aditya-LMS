...
const Certificate = () => {
  ...
  useEffect(() => {
    ...
    async function fetchUserDetails() {
      try {
        const response = await  fetch(`https://backend-production-eff3.up.railway.app/api/users/${id}`);
    ...
    async function fetchCourse() {
      try {
        const response = await fetch(`https://backend-production-eff3.up.railway.app/api/courses/${courseId}`);
