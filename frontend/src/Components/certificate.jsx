...
const Certificate = () => {
  ...
  useEffect(() => {
    ...
    async function fetchUserDetails() {
      try {
        const response = await  fetch(`https://backend-production-5243.up.railway.app/api/users/${id}`);
    ...
    async function fetchCourse() {
      try {
        const response = await fetch(`https://backend-production-5243.up.railway.app/api/courses/${courseId}`);
