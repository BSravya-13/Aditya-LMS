...
function YourComponent() {
  ...
  useEffect(() => {
   fetch(`https://backend-production-5243.up.railway.app/api/questions/${courseId}`)
      .then(res => res.json())
      .then(res => {
        setTest(res);
...
const handleMarks = () =>{
  const data = {
   ...
   axios.post(`https://backend-production-5243.up.railway.app/api/assessments/add/${userId}/${courseId}`, data)
  .then(response => {
